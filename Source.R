...
Campylobacter_coli_graphic <- ggplot(Campylobacter_coli_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
...
Campylobacter_jejuni_graphic <- ggplot(Campylobacter_jejuni_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_fetus_graphic <- ggplot(Campylobacter_fetus_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_hepaticus_graphic <- ggplot(Campylobacter_hepaticus_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_hyointestinalis_graphic <- ggplot(Campylobacter_hyointestinalis_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_lari_graphic <- ggplot(Campylobacter_lari_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_sp_graphic <- ggplot(Campylobacter_sp_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
Campylobacter_subantarcticus_graphic <- ggplot(Campylobacter_subantarcticus_mean, aes(x=Source, y=percentage, fill=Source)) +
  xlab("") +
  ylab("") +
  geom_bar(stat="identity") + # bar plot
  theme(legend.key.size = unit(0.1, "cm"), 
...
#Joining the graphs
source_AMR_Species <- ggarrange(Campylobacter_coli_graphic,
...
annotate_figure(source_AMR_Species, 
                top=text_grob("The Percentage Level of Resistance Per Source of the Different Campylobacter Species"), 
...
source_AMR_Class<-ggarrange(aminographic,betagraphic,fosfographic,
...
annotate_figure(source_AMR_Class, 
                top=text_grob("The Percentage Level of Resistance of the Different Antibiotic Classes per Source"), 
                #bottom=text_grob("Source"), 
                left = text_grob("Level of resistance (%)",rot = 90, vjust = 1))