...
getwd()
setwd("C:/Users/jadea/Documents/Applied Data Sciences/Assessment 2/Exported Datasets")
workingdir = "."
...
write_csv2(d2,"Book2_Final.csv") #Important to add the extension and keep ""
